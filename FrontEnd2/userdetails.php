...
$mentor_sql =$client->query("SELECT * FROM Mentor");
    ...
    <div class="row">
        <div class="col-sm-3">
            ...
            <div class="panel-heading" class = "nameofuser"><?php echo $Fname." ".$LName; ?>
                ...
                <div class="">
                    <img class="img-responsive" class='thumbnail' src="pictures/profile.jpg" alt="">
            ...
            <ul class="list-group">
                ...
                <button type="button" class="btn btn-success"><a href="userupdate.php">Update Your Profile</a></button>
                <br>
                <br>
            </div>
            ...
            <ul class="list-group">
                <li class="list-group-item text-right"><span class="pull-left"><strong class="">
                    ...
                    <?php
                    try{
                        foreach ($mentor_sql as $row) 
                        {   
                            $Ment_Fname = $row->First_Name;
                            $Ment_Lname = $row->Last_Name;
                            $Ment_email = $row->Email;
                            echo "<a href='alluserdetails.php?email=".$Ment_email."' >" .$Ment_Fname." ".$Ment_Lname ."</a> <br> ";
                        }
                        }catch(OutOfBoundsException $e){
                ...
                <li class="list-group-item text-right"><span class="pull-left"><strong class="">Mentor 2:</strong></span>     13</li>
            </ul>   
            </div>
